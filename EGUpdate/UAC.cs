...
namespace EGUpdate {
    class UAC {
        ...
        public static string[] PathAndArgs() {
            string[] sRet = new string[2];
            string sCmdLine = Environment.CommandLine;
            if (sCmdLine[0] == '"') {
                sRet[0] = sCmdLine.Substring(0, sCmdLine.IndexOf('"', 1) + 1);
            } else {
                sRet[0] = sCmdLine.Substring(0, sCmdLine.IndexOf(".exe") + 4);
            }
            sRet[1] = sCmdLine.Substring(sRet[0].Length).TrimStart(' ');
            return sRet;
        }
        public static string Args() {
            return PathAndArgs()[1];
        }
        public static string Path() {
            return PathAndArgs()[0];
        }
        ...
        public static void SelfElevate() {
            ...
            if (!IsRunAsAdmin()) {
                ...
                try {
                    ...
                    throw new SecurityException("User refused to elevate updater");
                }
                Environment.Exit(1);
            }
        }
